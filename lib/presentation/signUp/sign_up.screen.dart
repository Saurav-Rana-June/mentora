...
class SignUpScreen extends GetView<SignUpController> {
    ...
    return Scaffold(
      body: SafeArea(
        child: Stack(
          ...
          children: [buildBody(context), buildButton()],
        ),
      ),
    );
  }
  ...
  Padding buildBody(BuildContext context) {
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [buildAppbar(), Spacing.s20.h, buildForm(context)],
        ),
      ),
    );
  }

  CustomPrimaryButton buildButton() {
  ...
  Row buildAppbar() {
    return Row(children: [CustomBackButton()]);
  }
}
