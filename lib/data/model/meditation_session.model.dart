...
final List<MeditationSessionModel> mockMeditationSessions = [
  MeditationSessionModel(
    ...
    isFeatured: true,
    description:
        'Start your morning with a clear mind and sharp attention. This session will ground your awareness and help you approach your day with purpose and calm alignment.',
  ...
  MeditationSessionModel(
    ...
    duration: '25 min',
    imageUrl:
        'https://images.unsplash.com/photo-1511295742364-92767fa62d9f?q=80&w=600',
    isFeatured: true,
    description:
        'Transition smoothly into a deep, healing sleep. Soft breathing patterns and gentle body scans will release muscle tension and calm your racing thoughts.',
    soundTrack:
        'https://soundcloud.com/meditation-music/sets/the-meditation-collection',
  ),
  MeditationSessionModel(
    id: '3',
    ...
    isFeatured: true,
    description:
        'Release accumulated stress and anxiety. Learn powerful grounding techniques to stabilize your mind and reclaim peace in moments of turbulence.',
  ...
  MeditationSessionModel(
    ...
    duration: '12 min',
    imageUrl:
        'https://images.unsplash.com/photo-1508672019048-805c876b67e2?q=80&w=600',
    isFeatured: false,
  ),
  MeditationSessionModel(
    id: '5',
  ...
  MeditationSessionModel(
    ...
    duration: '10 min',
    imageUrl:
        'https://images.unsplash.com/photo-1472653425572-cf5b2c73f475?q=80&w=600',
    isFeatured: false,
  ),
  MeditationSessionModel(
    id: '9',
